...
<div class="admin-container">
    <div class="admin-header">
        <h1 class="admin-title">Crear Nueva Noticia</h1>
    ...
    <div class="form-container">
        <form method="POST" action="{{ route('admin.articles.store') }}" enctype="multipart/form-data" class="admin-form">
            @csrf
            ...
            <div class="form-group">
                ...
                <textarea id="excerpt" 
                          name="excerpt" 
                          rows="3" 
                          class="form-textarea @error('excerpt') is-invalid @enderror">{{ old('excerpt') }}</textarea>
                @error('excerpt')
                    <span class="form-error">{{ $message }}</span>
                @enderror
            </div>
